			...
			<div className="prices__content">
				...
				<div className="prices__plans">
					<PricesCard
						...
						features={['Refonte graphique', 'Modification de contenu', "Ajout d'une version adaptée mobile et tablette",'Animations des éléments du site', 'Amélioration du référencement en ligne', "Optimisation des performances", "Audit", "Débogage", "Maintenance technique"]}
					/>
					<PricesCard
						popular={true}
						title="Essentiel"
