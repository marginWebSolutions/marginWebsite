...
export default function JSONLD () {
  const businessInfo = {
    ...
    "description": "Margin Web Solutions offre des services de création de sites internet personnalisés pour artisans et PME à Saint-Étienne et Nevers. Nous fournissons des solutions web sur mesure, optimisées pour le SEO et le design responsive, afin de développer votre présence en ligne.",
    "address": {
      "@type": "PostalAddress",
    ...
    "priceRange": "€€",
    "areaServed": ["Saint-Etienne, Loire, Auvergne-Rhône-Alpes, Nevers, Nièvre, Bourgogne-Franche-Comté"],
